...
const topics = [
  {
    id: 1,
    label: "Apple Silicon M4 Release",
    first_seen: "Apr 29",
    last_seen: "May 1",
    mentions: 15420,
    score: 98.5,
  ...
  {
    id: 3,
    label: "Shopee Data Breach Rumor",
    first_seen: "May 1",
    last_seen: "May 1",
    mentions: 8430,
    score: 88.4,
                  ...
                  <li key={topic.id}>
                    ...
                    >
                      ...
                      <div className="flex items-start justify-between gap-2">
                        ...
                        <span
                          className={`text-[10px] font-semibold tabular-nums shrink-0 px-1.5 py-0.5 rounded-md ${
                            isActive
              ...
              <div className="flex gap-3">
                ...
                <div className="rounded-lg bg-slate-50 border border-slate-200/60 px-4 py-3 min-w-[120px]">
                  ...
                  <p className="mt-0.5 text-2xl font-bold tabular-nums text-slate-900">
                    {activeTopic.mentions.toLocaleString()}
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 xl:grid-cols-12 gap-5">
            <div className="xl:col-span-5 rounded-xl bg-white border border-slate-200/80 shadow-[0_1px_2px_rgba(15,23,42,0.04)] p-6">
              <div className="flex items-center justify-between mb-4">
                ...
                <span className="text-[11px] font-medium text-slate-500">{12} terms</span>
              </div>
              <WordCloud />
            </div>
